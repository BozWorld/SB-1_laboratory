...
# === Manager ===
var _physic_handler: PhysicHandler
...
func _initialize_systems():
	...
	_physic_handler.setup(flight_config if flight_config else _create_default_config())
...
func _connect_signals():
	...
	_physic_handler.speed_updated.connect(_on_speed_updated)
	_physic_handler.boom_triggered.connect(_on_boom_triggered)
...
func _physics_process(delta: float) -> void:
	...
	var physics_result = _physic_handler.update_physics(input_data, delta, is_grounded, -basis.z, basis.y)
...
"
		debug_ui.text = ( 
			_physic_handler.get_debug_string() + "\n" +
			texte_trails + "\n" +
